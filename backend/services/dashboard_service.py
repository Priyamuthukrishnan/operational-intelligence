...
class DashboardService:
    ...
    def get_operational_dashboard(self) -> OperationalDashboardResponse:
        ...
        return OperationalDashboardResponse(
            ...
            sentiment_score=convert_sentiment_score(stats["average_sentiment"]),
            average_sentiment_label=sentiment_label_from_score(stats["average_sentiment"]),
            risk_score=convert_escalation_risk_score(stats["average_escalation_risk"]),
    ...
    def get_executive_dashboard(self) -> ExecutiveDashboardResponse:
        ...
        for c, customer_name in at_risk_list:
            ...
            at_risk_customers.append(
                AtRiskCustomer(
                    ...
                    sentiment_score=convert_sentiment_score(c.sentiment_average),
                    sentiment_average_label=sentiment_label_from_score(c.sentiment_average),
                    risk_score=convert_escalation_risk_score(c.escalation_risk_average),
        ...
        return ExecutiveDashboardResponse(
            ...
            sentiment_score=convert_sentiment_score(general_stats["average_sentiment"]),
    ...
    def get_customer_dashboard(self, customer_id: uuid.UUID) -> CustomerDashboardResponse:
        ...
        detail_list = [
            CustomerInteractionDetail(
                ...
                sentiment_score=convert_sentiment_score(i.sentiment_score),
                risk_score=convert_escalation_risk_score(i.escalation_risk_score),
                risk_band=i.escalation_risk_band,
                confidence_score=convert_root_cause_confidence(i.root_cause_confidence),
        ...
        return CustomerDashboardResponse(
            ...
            sentiment_score=convert_sentiment_score(sentiment_avg),
            sentiment_average_label=sentiment_label_from_score(sentiment_avg),
            risk_score=convert_escalation_risk_score(risk_avg),
